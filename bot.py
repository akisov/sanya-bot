...
SANYA_PATTERN = re.compile(
    r'(?<![а-яёА-ЯЁa-zA-Z])'
    r'(?:саня|сань|сане|саней|саню|саней|санёк|санек|санчос|санчес|санчез|санюха|санюша|санёчек|санечек|саныч|сантос|сандро|сантик|санчик|санёша|санюшка|степанов)'
    r'(?![а-яёА-ЯЁa-zA-Z])',
